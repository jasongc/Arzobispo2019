...
namespace NetPdf
{
    public class pdfPage : PdfPageEventHelper
    {
        ...
        protected Font footer
        {
            get
            {
                //var color1 = int.Parse(System.Configuration.ConfigurationManager.AppSettings["color1"]);
                //var color2 = int.Parse(System.Configuration.ConfigurationManager.AppSettings["color2"]);
                //var color3 = int.Parse(System.Configuration.ConfigurationManager.AppSettings["color3"]);
                var grey = new BaseColor(0, 98, 145);
                var font = FontFactory.GetFont("Calibri", 9, iTextSharp.text.Font.BOLD, grey);
                return font;
            }
        }
        ...
        public override void OnEndPage(PdfWriter writer, Document doc)
        {
            //var rutaImg = System.Configuration.ConfigurationManager.AppSettings["imgFooter2"];
